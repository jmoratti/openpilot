...
class TestParams(unittest.TestCase):
  ...
  def test_params_get_cleared_panda_disconnect(self):
    ...
    self.params.clear_all(TxType.CLEAR_ON_PANDA_DISCONNECT)
  ...
  def test_params_get_cleared_manager_start(self):
    ...
    self.params.put("DongleId", "cb38263377b873ee")
    assert self.params.get("CarParams") == b"test"
    self.params.clear_all(TxType.CLEAR_ON_MANAGER_START)
    assert self.params.get("CarParams") is None
    assert self.params.get("DongleId") is not None
  ...
  def test_params_get_cleared_ignition(self):
    ...
    self.params.clear_all(TxType.CLEAR_ON_IGNITION)
